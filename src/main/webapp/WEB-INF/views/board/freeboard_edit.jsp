...
<body>
	<form method="post"
		action="freeboard_edit_ok?board_no=${b.board_no}&page=${page}"
		...
		<table border="1">
			...
			<tr>
				<th>글쓴이</th>
				<td><input name="board_writer" id="board_writer" size="14"
					value="${b.board_writer}" /></td>
			...
			<tr>
				<th>글내용</th>
				<td><textarea name="board_cont" id="board_cont" rows="10"
